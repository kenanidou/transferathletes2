var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Εισήγηση μεταγραφής αθλητών-φοιτητών",
      pageTitle: "Εισήγηση μεταγραφής αθλητών-φοιτητών",
      infoTitle: " Πληροφορίες για την εισήγηση μεταγραφής αθλητών-φοιτητών",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε μεταγραφή αθλητή.",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Student athlete transfer proposal",
      pageTitle: "Student athlete transfer proposal",
      infoTitle: "Information on recommending student-athlete transfers",
      subTitle1: "This questionnaire can help you determine if you are eligible to receive the student-athlete transfers.",
